  ...
  [3],
  {
    76: function (t, e, n) {
      ...
      var i,
        ...
        m = "function" == typeof WeakSet ? new WeakSet() : new Set(),
        p = function (t, e, n) {
          var i;
          return function () {
            e.value >= 0 &&
              (n || m.has(e) || "hidden" === document.visibilityState) &&
              ((e.delta = e.value - (i || 0)),
            ...
            r = function (t) {
              "first-contentful-paint" === t.name &&
                ...
                t.startTime < i.timeStamp &&
                  ((a.value = t.startTime), a.entries.push(t), m.add(a), n()));
            },
            ...
            s(function (i) {
              (a = u("FCP")),
                ...
                requestAnimationFrame(function () {
                  requestAnimationFrame(function () {
                    (a.value = performance.now() - i.timeStamp), m.add(a), n();
                  });
                });
            }));
        },
        ...
        w = function (t, e) {
          i ||
            ((i = e), (a = t), (r = new Date()), b(removeEventListener), L());
        },
        L = function () {
          if (a >= 0 && a < r - E) {
            var t = {
        ...
        k = function (t, e) {
          ...
          if (o) {
            ...
            var d = function () {
              m.has(a) ||
                (o.takeRecords().map(r), o.disconnect(), m.add(a), n());
            };
...
//# sourceMappingURL=3.5772815d.chunk.js.map
